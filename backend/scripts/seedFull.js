...
const productDefs = [
  ...
  },
  {
    ...
    description:
      'Professional-grade portrait lens with ultra-fast f/1.4 aperture, nano-coated glass elements, silent STM motor, and weather-sealed body.',
    price: 449.99,
    comparePrice: 549.99,
    discountPercentage: 18,
    sku: 'CAM-LNS-007',
  ...
  },
  {
    ...
    description:
      'Eco-friendly TPE yoga mat with alignment marks, non-slip dual texture, carrying strap, and antimicrobial surface.',
    price: 59.99,
    comparePrice: 79.99,
  ...
  },
  {
    ...
    description:
      'Lightweight carbon-plate running shoes with responsive ZoomX foam, breathable Flyknit upper, and 8mm drop.',
    price: 179.99,
    comparePrice: 219.99,
    discountPercentage: 18,
    sku: 'SHO-RUN-009',
    ...
    attributes: {
      sizes: ['8', '9', '10', '11', '12'],
      colors: ['Volt Green', 'Pure Black', 'Summit White'],
      brand: 'CloudWalk',
    },
    isFeatured: true,
  },
  {
    ...
    description:
      'Wireless charging desk lamp with 5 color temperatures, 10 brightness levels, USB-C port, and touch controls.',
    price: 69.99,
    comparePrice: 89.99,
  ...
  },
  {
    ...
    description:
      'Smart scale measuring 13 body metrics including body fat, muscle mass, BMI, and bone density via BIA sensors.',
    price: 49.99,
    comparePrice: 69.99,
  ...
  },
  {
    ...
    description:
      'Ultra-thin 16-inch laptop with M3 chip, 16GB unified memory, 512GB SSD, Liquid Retina XDR display, and 22-hour battery.',
    price: 1299.99,
  ...
  },
  {
    ...
    description:
      'True wireless earbuds with active noise cancellation, spatial audio, IPX5 rating, and 30-hour total battery.',
    price: 129.99,
    comparePrice: 159.99,
    discountPercentage: 19,
    sku: 'AUD-EBD-013',
  ...
  },
  {
    ...
    description:
      'Automated hydroponic garden with full-spectrum LED grow lights, water pump, and mobile app control for herbs and greens.',
    price: 149.99,
    comparePrice: 199.99,
    discountPercentage: 25,
    sku: 'GDN-PLN-014',
  ...
  },
  {
    ...
    description:
      'Large-room HEPA H13 air purifier with real-time PM2.5 display, whisper-quiet mode, and app control for rooms up to 1200 sq ft.',
    price: 199.99,
    comparePrice: 279.99,
    discountPercentage: 29,
    sku: 'HME-PUR-015',
  ...
  },
  {
    ...
    description:
      'Quick-adjust 5-52.5 lb dumbbell pair with ergonomic grip, 15 weight settings, and compact storage tray.',
    price: 349.99,
    comparePrice: 449.99,
    discountPercentage: 22,
    sku: 'FIT-DBL-016',
  ...
  },
  {
    ...
    description:
      'Premium glass-bead weighted blanket with removable bamboo duvet cover, 7-layer construction for even weight distribution.',
    price: 89.99,
    comparePrice: 119.99,
    discountPercentage: 25,
    sku: 'HME-BLN-017',
    ...
    reviewCount: 53,
    attributes: {
      colors: ['Charcoal Gray', 'Navy', 'Slate Blue'],
  ...
  },
  {
    ...
    description:
      '12.9-inch AMOLED tablet with S-Pen support, 256GB storage, quad speakers, and desktop-class performance.',
    price: 599.99,
    comparePrice: 749.99,
    discountPercentage: 20,
    sku: 'TAB-PRO-018',
  ...
  },
  {
    ...
    description:
      'High-performance electric skateboard with dual 600W motors, 25 mph top speed, 20-mile range, and regenerative braking.',
    price: 599.99,
    comparePrice: 799.99,
    discountPercentage: 25,
    sku: 'SKT-ELC-019',
  ...
  },
  {
    ...
    description:
      'Carry-on travel backpack with clamshell opening, hidden laptop compartment, USB-C charging port, and anti-theft zippers.',
    price: 119.99,
    comparePrice: 159.99,
    discountPercentage: 25,
    sku: 'TRV-BAG-020',
...
const serviceDefs = [
  {
    ...
    description: 'Standard doctor consultation for diagnosis and treatment.',
    category: 'general',
    duration: 30,
    price: 100.0,
    depositRequired: 0,
  },
  {
    ...
    description: 'Specialized skin consultation with examination.',
  ...
  },
  {
    ...
    description: 'Comprehensive heart health screening with ECG.',
    category: 'cardiology',
    duration: 45,
    price: 200.0,
    depositRequired: 75,
  ...
  {
    name: 'Invisalign Assessment',
    slug: 'invisalign-assessment',
    description: 'Initial orthodontic assessment for clear aligner treatment.',
  ...
  },
  {
    ...
    slug: 'acne-treatment-plan',
    description: 'Comprehensive acne evaluation and personalized treatment plan.',
    category: 'dermatology',
    duration: 30,
    price: 175.0,
    depositRequired: 50,
  },
  {
    ...
    description: 'Complete annual health checkup with blood work order.',
    category: 'general',
    duration: 60,
    price: 250.0,
    depositRequired: 0,
  ...
  try {
    ...
    const [admin, vendor, customer, customer2] = await Promise.all([
      ...
      User.create({
        ...
        phone: '+1 555-0101',
        address: { ...addr, street: '200 Market St', city: 'Austin', state: 'TX' },
        isVerified: true,
        isActive: true,
      }),
      User.create({
        ...
        phone: '+1 555-0102',
        address: { ...addr, street: '350 5th Ave', city: 'New York', state: 'NY' },
        isVerified: true,
        isActive: true,
      }),
      User.create({
        ...
        phone: '+1 555-0103',
        address: { ...addr, street: '123 Main St', city: 'Los Angeles', state: 'CA' },
        isVerified: true,
        isActive: true,
      }),
    ]);
    console.log(
      `Seeded 4 users. (IDs: ${admin.id}, ${vendor.id}, ${customer.id}, ${customer2.id})`
    );
    ...
    for (let i = 0; i < 15; i++) {
      ...
      await Order.create({
        ...
        items: [
          {
            ...
            selectedColor: prod.attributes?.colors?.[0] || '',
          },
        ],
        ...
        deliveredAt:
          statuses[i] === 'delivered' ? new Date(Date.now() - (daysAgo - 3) * 86400000) : null,
        status: statuses[i],
    ...
    await Notification.bulkCreate([
      {
        ...
        message: 'Your order #ORD-20260801-ABC has been delivered.',
        read: false,
      },
      {
        recipient: customer.id,
        ...
        message: 'Use code WELCOME15 for 15% off.',
        read: true,
        readAt: new Date(),
      },
      {
        ...
        message: 'Production-grade seed data loaded successfully.',
        read: false,
      },
    ]);
