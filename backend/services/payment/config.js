...
const getGatewayConfig = (gateway) => {
  const configs = {
    ...
    paypal: {
      enabled: Boolean(
        process.env.PAYPAL_CLIENT_ID && !process.env.PAYPAL_CLIENT_ID.includes('your_')
      ),
    ...
    square: {
      enabled: Boolean(
        process.env.SQUARE_ACCESS_TOKEN && !process.env.SQUARE_ACCESS_TOKEN.includes('your_')
      ),
    ...
    bkash: {
      enabled: Boolean(process.env.BKASH_APP_KEY && !process.env.BKASH_APP_KEY.includes('your_')),
    ...
    flutterwave: {
      enabled: Boolean(
        process.env.FLUTTERWAVE_SECRET_KEY && !process.env.FLUTTERWAVE_SECRET_KEY.includes('your_')
      ),
    ...
    paytm: {
      enabled: Boolean(
        process.env.PAYTM_MERCHANT_ID && !process.env.PAYTM_MERCHANT_ID.includes('your_')
      ),
    ...
    mollie: {
      enabled: Boolean(process.env.MOLLIE_API_KEY && !process.env.MOLLIE_API_KEY.includes('your_')),
      apiKey: process.env.MOLLIE_API_KEY,
      organizationId: process.env.MOLLIE_ORGANIZATION_ID,
    },
    liqpay: {
      enabled: Boolean(
        process.env.LIQPAY_PUBLIC_KEY && !process.env.LIQPAY_PUBLIC_KEY.includes('your_')
      ),
      publicKey: process.env.LIQPAY_PUBLIC_KEY,
      privateKey: process.env.LIQPAY_PRIVATE_KEY,
    },
    paddle: {
      enabled: Boolean(process.env.PADDLE_API_KEY && !process.env.PADDLE_API_KEY.includes('your_')),
...
export { getGatewayConfig, getEnabledGateways, isGatewayEnabled };
